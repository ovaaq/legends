...
- **3 Actions:** Used to perform activities requiring an [[Action]], [[Double Action]], or [[Triple Action]].
- **Movement:** You can move up to your [[Walking Speed]].
- **1 Reaction:** Used once per [[Round]] when its specific trigger occurs, even if the trigger occurs outside your [[Turn]].
- **Free Actions:** Minor activities that require no Actions or other resources.
...
|         Action         | Description                                                                                                |
| :--------------------: | ---------------------------------------------------------------------------------------------------------- |
|     [[Demoralize]]     | Make an [[Intimidation]] [[Check]] to frighten a [[Creature]].                                             |
|    [[Drink Potion]]    | Drink one [[Potion]] you are holding.                                                                      |
...
|     Action      | Description                                                                                                                               |
| :-------------: | ----------------------------------------------------------------------------------------------------------------------------------------- |
| [[Disarm Trap]] | Make [[Sleight of Hand]] ([[Thieves' Tools]]) [[Check]] to disarm a [[Trap]].                                                             |
|  [[Pick Lock]]  | Make [[Sleight of Hand]] ([[Thieves' Tools]]) [[Check]] to open a [[Lock]].                                                               |
|   [[Sprint]]    | Gain additional movement equal to 3x your [[Walking Speed]], then make a DC 15 [[Constitution Saving Throw]] to avoid gaining [[Winded]]. |

### Free Action ( **〇** )

|      Action       | Description                                                                      |
| :---------------: | -------------------------------------------------------------------------------- |
| [[Dismiss Spell]] | End [[Concentration]] on a spell.                                                |
|  [[Drop Object]]  | Drop one [Object](Object) you are holding onto the ground within 1 metre of you. |
|  [[Fall Prone]]   | Fall [Prone](Prone).                                                             |
