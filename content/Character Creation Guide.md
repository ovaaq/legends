...
*Carved from the heart of stone itself, dwarves are a long-lived and enduring folk. Their bond with the earth runs deep; stone, metal, and gems feel as much a part of them as flesh and blood. Though their origins lie in the deep places of the world, dwarves have spread far across the realms, adapting to mountain strongholds, bustling cities, and distant frontiers alike.*
>
...
```dataview
TABLE WITHOUT ID file.link AS "List of Backgrounds"
FROM #background
WHERE file.name != "Background Template" AND file.name != "Character Creation Guide"
SORT file.name ASC
```
...
**Cost**: 1 Legend Point
>
> *You have learned to siphon vitality from living creatures, turning their essence into your own strength.*
>
...
>
>
*Following Talents: [[Blood Frenzy]]*
>
> *Part of [[Vampire Talent Tree]]*
>
...
```dataview
TABLE WITHOUT ID file.link AS "Packs",
Weight,
Price
...
*Chefs kiss* Brûni's character sheet is now ready to play!
